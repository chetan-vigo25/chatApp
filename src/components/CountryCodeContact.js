...
const CountryCodeContact = ({
  ...
  return (
    <>
      <TouchableOpacity onPress={() => !disabled && setShowModal(true)} style={{ fwidth:60, height:52, justifyContent:'center', alignItems:'center', }} >
        <View style={{ flex:1, alignItems:'center', justifyContent:'center', }} >
          <Text style={{ fontFamily: 'Poppins-Regular', fontSize: 14, color: theme.colors.primaryTextColor }} >{selectedCountry?.code || ''}</Text>
        </View>
      </TouchableOpacity>
