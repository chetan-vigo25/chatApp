...
const styles = StyleSheet.create({
  ...
  qRow: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", paddingHorizontal: 12, paddingVertical: 14, gap: 12 },
  question: { fontFamily: "Roboto-Medium", fontSize: 15, flex: 1, lineHeight: 20 },
  answer: { fontFamily: "Roboto-Regular", fontSize: 14, lineHeight: 20, paddingHorizontal: 12, paddingBottom: 14 },
